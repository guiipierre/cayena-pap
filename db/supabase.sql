...
CREATE TABLE IF NOT EXISTS public.establishments (
  ...
  ultimo_vendedor_nome TEXT,
  tipo_cozinha TEXT,
  recencia_cliente TEXT,
  limite_aprovado TEXT,
  proprietario_nome TEXT,
  prazo_pagamento TEXT,
  metodo_pagamento TEXT,
  ultimo_pedido_info TEXT,
  tipo_do_estabelecimento TEXT,
  origem_lead TEXT,
...
-- Admin: cadastro / merge por CNPJ atribuído a um vendedor (importação em massa)
